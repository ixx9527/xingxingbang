...
DEFAULT_BEHAVIORS = [
    ...
    {"name": "早起不赖床", "points": 2, "category": "生活习惯", "icon": "🌅"},
    {"name": "自己整理房间", "points": 3, "category": "生活习惯", "icon": "🛏️"},
    {"name": "按时睡觉", "points": 2, "category": "生活习惯", "icon": "😴"},
    {"name": "挑食/剩饭", "points": -2, "category": "生活习惯", "icon": "🍚"},
    {"name": "主动收拾玩具", "points": 2, "category": "生活习惯", "icon": "🧸"},
